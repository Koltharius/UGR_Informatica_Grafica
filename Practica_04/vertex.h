...
//
// Domingo Martin Perandres 2003-2016
//
// GPL3
//
...
public:
  _matrix4();
  Type get(int fila, int columna);
  void set(int fila, int columna, Type valor);
  void matrizIdentidad();
};

//*************************************************************************
// _matrix4 function implementation
//*************************************************************************

template <class Type> _matrix4<Type>::_matrix4::_matrix4() {
  matrix.resize(4);
...
template <class Type>
Type _matrix4<Type>::_matrix4::get(int fila, int columna) {
  return matrix[fila][columna];
}

template <class Type>
void _matrix4<Type>::_matrix4::set(int fila, int columna, Type valor) {
  matrix[fila][columna] = valor;
}

template <class Type> void _matrix4<Type>::_matrix4::matrizIdentidad() {
...
template <class Type> class _plane : public _vertex4<Type> {
public:
  _plane(Type x1 = 0, Type y1 = 0, Type z1 = 0, Type w1 = 0);
  _plane(const _vertex4<Type> &Vertex1);
  _plane<Type> &operator=(_plane &Plane1);
  int compute_coefficients(_vertex3<Type> Vertex1, _vertex3<Type> Vertex2,
                           _vertex3<Type> Vertex3);
...
template <class Type> class _bounding_box3 {
public:
  _vertex3<Type> Minimum, Maximum;
  bool Computed;

  _bounding_box3(Type XMin1 = (Type)MAX_FLOAT_VALUE,
                 Type YMin1 = (Type)MAX_FLOAT_VALUE,
                 Type ZMin1 = (Type)MAX_FLOAT_VALUE,
                 Type XMax1 = -(Type)MAX_FLOAT_VALUE,
                 Type YMax1 = -(Type)MAX_FLOAT_VALUE,
                 Type ZMax1 = -(Type)MAX_FLOAT_VALUE);
...
template <class Type>
_vertex2<Type> &_vertex2<Type>::operator()(Type x1, Type y1) {
  x = x1;
  y = y1;
  return (*this);
}
...
template <class Type>
_vertex2<Type> &_vertex2<Type>::operator()(const _vertex2<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  return (*this);
}
...
template <class Type>
_vertex2<Type> &_vertex2<Type>::operator()(const _vertex3<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  return (*this);
}
...
template <class Type>
_vertex2<Type> &_vertex2<Type>::operator()(const _vertex4<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  return (*this);
}
...
template <class Type>
_vertex2<Type> &_vertex2<Type>::operator()(Type *Vertices1) {
  x = Vertices1[0];
  y = Vertices1[1];
  return (*this);
}
...
template <class Type> _vertex2<Type> _vertex2<Type>::operator*(Type Value) {
  _vertex2<Type> VertexTemp(*this);
...
template <class Type>
bool _vertex2<Type>::operator==(const _vertex2<Type> &Vertex1) {

  if (x == Vertex1.x && y == Vertex1.y)
    return true;
  return false;
}
...
template <class Type> _vertex2<Type> &_vertex2<Type>::normalize() {
...
template <class Type> void _vertex2<Type>::show_values() {
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::operator()(Type x1, Type y1, Type z1) {
  x = x1;
  y = y1;
  z = z1;
  return (*this);
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::operator()(const _vertex2<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  return (*this);
}
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::operator()(const _vertex3<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  z = Vertex1.z;
  return (*this);
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::operator()(const _vertex4<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  z = Vertex1.z;
  return (*this);
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::operator()(Type *Vertices1) {
  x = Vertices1[0];
  y = Vertices1[1];
  z = Vertices1[2];
  return (*this);
...
template <class Type> _vertex3<Type> _vertex3<Type>::operator*(Type Value) {
  _vertex3<Type> VertexTemp(*this);
...
template <class Type>
_vertex3<Type> _vertex3<Type>::operator*(_matrix4<Type> &Matrix1) {
  _vertex3<Type> VertexTemp(*this);
  _vertex4f Vertex1(*this);
  _vertex4f Colum1(Matrix1.get(0, 0), Matrix1.get(1, 0), Matrix1.get(2, 0),
                   Matrix1.get(3, 0)),
      Colum2(Matrix1.get(0, 1), Matrix1.get(1, 1), Matrix1.get(2, 1),
             Matrix1.get(3, 1)),
      Colum3(Matrix1.get(0, 2), Matrix1.get(1, 2), Matrix1.get(2, 2),
             Matrix1.get(3, 2));
...
template <class Type>
_vertex3<Type> _vertex3<Type>::cross_product(const _vertex3<Type> &Vertex1) {
...
template <class Type>
bool _vertex3<Type>::operator==(const _vertex3<Type> &Vertex1) {

  if (x == Vertex1.x && y == Vertex1.y && z == Vertex1.z)
    return true;
  return false;
}
...
template <class Type>
bool _vertex3<Type>::operator==(const _vertex2<Type> &Vertex1) {
...
template <class Type>
bool _vertex3<Type>::equal_coordinates(int Num_coordinates1) {
...
template <class Type> _vertex3<Type> &_vertex3<Type>::normalize() {
  Type Module = this->module();
...
template <class Type> _vertex3<unsigned char> _vertex3<Type>::to_byte() {
...
template <class Type>
_vertex3<Type> &_vertex3<Type>::from_byte(_vertex3<unsigned char> &Vertex1) {
...
template <class Type>
Type _vertex3<Type>::compute_angle(const _vertex3<Type> &Vertex1) {
  _vertex3f Auxiliar;
  float cosine, sine;
...
template <class Type> void _vertex3<Type>::show_values() {
...
template <class Type>
_vertex4<Type>::_vertex4(Type x1, Type y1, Type z1, Type w1) {
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::operator()(Type x1, Type y1, Type z1, Type w1) {
  x = x1;
  y = y1;
  z = z1;
  return (*this);
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::operator()(const _vertex2<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  return (*this);
}
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::operator()(const _vertex3<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  z = Vertex1.z;
  return (*this);
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::operator()(const _vertex4<Type> &Vertex1) {
  x = Vertex1.x;
  y = Vertex1.y;
  z = Vertex1.z;
  w = Vertex1.w;
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::operator()(Type *Vertices1) {
  x = Vertices1[0];
  y = Vertices1[1];
  z = Vertices1[2];
  w = Vertices1[3];
...
template <class Type> _vertex4<Type> _vertex4<Type>::operator*(Type Value) {
  _vertex4<Type> VertexTemp(*this);
...
template <class Type>
_vertex4<Type> _vertex4<Type>::operator*(_matrix4<Type> &Mat1) {
...
template <class Type>
bool _vertex4<Type>::operator==(const _vertex4<Type> &Vertex1) {

  if (x == Vertex1.x && y == Vertex1.y && z == Vertex1.z && w == Vertex1.w)
    return true;
  return false;
}
...
template <class Type> _vertex4<Type> &_vertex4<Type>::project() {
...
template <class Type> _vertex4<Type> &_vertex4<Type>::normalize() {
  Type Module = this->module();
...
template <class Type> _vertex4<unsigned char> _vertex4<Type>::to_byte() {
...
template <class Type>
_vertex4<Type> &_vertex4<Type>::from_byte(_vertex4<unsigned char> &Vertex1) {
  r = (Type)Vertex1.r / (Type)255.;
  g = (Type)Vertex1.g / (Type)255.;
  b = (Type)Vertex1.b / (Type)255.;
...
template <class Type> void _vertex4<Type>::show_values() {

  std::cout << "vertex: x=" << x << " y=" << y << " z=" << z << " w=" << w
            << endl;
}
...
template <class Type> _plane<Type>::_plane(Type x1, Type y1, Type z1, Type w1) {
...
template <class Type> _plane<Type>::_plane(const _vertex4<Type> &Vertex1) {
...
template <class Type>
int _plane<Type>::compute_coefficients(_vertex3<Type> Vertex1,
                                       _vertex3<Type> Vertex2,
                                       _vertex3<Type> Vertex3) {
  ...
  if ((v3.equal_coordinates(3) && v3.x == 0) == true) {
    // printf("Warning: plane.compute_coefficients->3 coordenates are equals and
    // 0 %s %d",__FILE__,__LINE__);
    return (-1);
  }
  ...
  this->y = v3.y / Mod;
  this->z = v3.z / Mod;
  this->w = -this->x * Vertex_aux1.x - this->y * Vertex_aux1.y -
            this->z * Vertex_aux1.z;
  return 0;
}
...
template <class Type>
_vertex_position _plane<Type>::compute_vertex_position(_vertex3<Type> Vertex1) {
  double Result;

  Result =
      this->x * Vertex1.x + this->y * Vertex1.y + this->z * Vertex1.z + this->w;

  if (Result > (double)COPLANE_THRESHOLD)
    return VERTEX_AHEAD_PLANE;
  if (Result < -(double)COPLANE_THRESHOLD)
    return VERTEX_BEHIND_PLANE;
...
template <class Type> _vertex3<Type> _plane<Type>::normal() {
...
template <class Type>
_bounding_box3<Type>::_bounding_box3(Type Xmin1, Type Ymin1, Type Zmin1,
                                     Type Xmax1, Type Ymax1, Type Zmax1) {
...
template <class Type>
_bounding_box3<Type>::_bounding_box3(
    const _bounding_box3<Type> &Bounding_box1) {
...
_bounding_box3<Type>::compute(const _vertex3<Type> &Vertex1) {
  ...
  if (Vertex1.x < Minimum.x)
    Minimum.x = Vertex1.x;
  if (Vertex1.y < Minimum.y)
    Minimum.y = Vertex1.y;
  if (Vertex1.z < Minimum.z)
    Minimum.z = Vertex1.z;
  if (Vertex1.x > Maximum.x)
    Maximum.x = Vertex1.x;
  if (Vertex1.y > Maximum.y)
    Maximum.y = Vertex1.y;
  if (Vertex1.z > Maximum.z)
    Maximum.z = Vertex1.z;
  return (*this);
}
...
_bounding_box3<Type>
_bounding_box3<Type>::compute(_bounding_box3<Type> &Bounding_box1) {
  if (Bounding_box1.Minimum.x < Minimum.x)
    Minimum.x = Bounding_box1.Minimum.x;
  if (Bounding_box1.Minimum.y < Minimum.y)
    Minimum.y = Bounding_box1.Minimum.y;
  if (Bounding_box1.Minimum.z < Minimum.z)
    Minimum.z = Bounding_box1.Minimum.z;
  if (Bounding_box1.Minimum.x > Maximum.x)
    Maximum.x = Bounding_box1.Maximum.x;
  if (Bounding_box1.Maximum.y > Maximum.y)
    Maximum.y = Bounding_box1.Maximum.y;
  if (Bounding_box1.Maximum.z > Maximum.z)
    Maximum.z = Bounding_box1.Maximum.z;
  return (*this);
}
...
template <class Type> _vertex3<Type> _bounding_box3<Type>::center() {
...
template <class Type> Type _bounding_box3<Type>::max_value() {
  Type Max_value = -(Type)MAX_FLOAT_VALUE;

  if (Max_value < Minimum.x)
    Max_value = Minimum.x;
  if (Max_value < Minimum.y)
    Max_value = Minimum.y;
  if (Max_value < Minimum.z)
    Max_value = Minimum.z;
  if (Max_value < Maximum.x)
    Max_value = Maximum.x;
  if (Max_value < Maximum.y)
    Max_value = Maximum.y;
  if (Max_value < Maximum.z)
    Max_value = Maximum.z;
  return (Max_value);
}
...
template <class Type> Type _bounding_box3<Type>::min_value() {
  Type Min_value = MAX_FLOAT_VALUE;

  if (Min_value > Minimum.x)
    Min_value = Minimum.x;
  if (Min_value > Minimum.y)
    Min_value = Minimum.y;
  if (Min_value > Minimum.z)
    Min_value = Minimum.z;
  if (Min_value > Maximum.x)
    Min_value = Maximum.x;
  if (Min_value > Maximum.y)
    Min_value = Maximum.y;
  if (Min_value > Maximum.z)
    Min_value = Maximum.z;
  return (Min_value);
}
...
template <class Type> void _bounding_box3<Type>::show_values() {
