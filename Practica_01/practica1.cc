...
// void draw_objects() {
//   GLfloat Vertices[8][3] = {{5, 0, 0},  {4, 4, 0},   {0, 5, 0},  {-4, 4, 0},
//                             {-5, 0, 0}, {-4, -4, 0}, {0, -5, 0}, {4, -4, 0}};
//   int i;
//
//   glColor3f(0, 1, 0);
//   glPointSize(4);
...
void draw_objects() {
  if (modo == "1") {
    ...
    _cubo.draw_aristas(0, 1, 0, 4);
  } else if (modo == "3") {
    _cubo.draw_solido(2, 0, 1);
  } else if (modo == "4") {
    _cubo.draw_solido_colores();
  } else if (modo == "5") {
    _cubo.draw_solido_ajedrez(1, 1, 0, 0, 0, 1);
  } else if (modo == "6") {
    ...
    _piramide.draw_solido_colores();
  } else if (modo == "0") {
    _piramide.draw_solido_ajedrez(1, 1, 0, 0, 0, 1);
  }
}
